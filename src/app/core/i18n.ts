...
const EN = {
  ...
  categoriesMet: 'category caps used',
  ...
  // --- compliance
  progress: 'Progress',
  requiredServings: 'Maximum servings',
  of: 'of',
  met: 'Met',
  shortBy: 'Short by',
  overMinimum: 'Within limit',
  available: 'Available',
  ...
  finalizeHint: 'Add at least one item, stay within each category maximum, and stay within the budget.',
  cannotFinalize: 'Cannot finalize while the order is empty or over a category or budget limit.',
  ...
  planOverview: 'Your 7-day meal plan',
  planReady: 'Meals organized by day using the food in your order.',
  mealsPlanned: 'meals planned',
  selectDay: 'Choose a day',
  planForDay: 'Plan for',
  viewAllDays: 'View all days',
  hideAllDays: 'Hide all days',
  allDays: 'All days',
...
const ES: Record<TranslationKey, string> = {
  ...
  categoriesMet: 'límites de categoría usados',
  ...
  progress: 'Progreso',
  requiredServings: 'Porciones máximas',
  of: 'de',
  met: 'Cumplido',
  shortBy: 'Faltan',
  overMinimum: 'Dentro del límite',
  ...
  finalizeHint: 'Agregue al menos un artículo, manténgase dentro de cada máximo de categoría y dentro del presupuesto.',
  cannotFinalize: 'No se puede finalizar mientras el pedido esté vacío o exceda un límite de categoría o presupuesto.',
  ...
  planOverview: 'Su plan de comidas de 7 días',
  planReady: 'Comidas organizadas por día usando los alimentos de su pedido.',
  mealsPlanned: 'comidas planificadas',
  selectDay: 'Elija un día',
  planForDay: 'Plan para',
  viewAllDays: 'Ver todos los días',
  hideAllDays: 'Ocultar todos los días',

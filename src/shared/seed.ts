...
export function seedProfile(): ProgramProfile {
  ...
  return {
    ...
    capBasis: 'per_member',
    requirements: [
      { categoryKey: 'fruit', servingsPerMemberPerDayUnits: 0, maxServingsPerMemberPerDayUnits: servingsToUnits(2), minDistinctItems: null },
      { categoryKey: 'vegetable', servingsPerMemberPerDayUnits: 0, maxServingsPerMemberPerDayUnits: servingsToUnits(3), minDistinctItems: null },
      { categoryKey: 'protein', servingsPerMemberPerDayUnits: 0, maxServingsPerMemberPerDayUnits: servingsToUnits(3), minDistinctItems: null },
      { categoryKey: 'starch', servingsPerMemberPerDayUnits: 0, maxServingsPerMemberPerDayUnits: servingsToUnits(4), minDistinctItems: null },
    ],
